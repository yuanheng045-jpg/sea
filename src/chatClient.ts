...
export type HubEvent =
  ...
  | { type: 'done'; id: string; role: string; content: string; thinking?: string; ts: string; reply_to?: string; images?: string[]; files?: Array<{ url: string; name?: string }>; htmls?: string[]; keepsakes?: any[] }
