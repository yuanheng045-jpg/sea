...
const SUXU_TOOL_ALIASES: Record<string, string> = {
  ...
  midroom_topics: 'midroom_topics',
  reading_shelf: 'reading_shelf',
  reading_passage: 'reading_passage',
  cli: 'lutopia_guide',
  lutopia_get_guide: 'lutopia_guide',
...
const SUXU_TOOL_TEXT: Record<string, ToolText> = {
  ...
  midroom_topics: () => '苏煦瞅了眼合相间在聊什么',
  reading_shelf: () => '苏煦翻了翻书架',
  reading_passage: () => '苏煦翻开书读了一段',
  lutopia_guide: () => '苏煦去论坛逛了一圈',
