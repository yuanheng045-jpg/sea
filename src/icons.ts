...
export type IconKey = 'cc' | 'api' | 'voice' | 'reading' | 'play' | 'theme' | 'status' | 'avatar-her' | 'avatar-his' | 'avatar-su' | 'avatar-you' | 'memory' | 'garden' | 'projects' | 'group' | 'tide' | 'callhistory'
type Icons = Record<IconKey, string | null>

const DEFAULT: Icons = { cc: null, api: null, voice: null, reading: null, play: null, theme: null, status: null, 'avatar-her': null, 'avatar-his': null, 'avatar-su': null, 'avatar-you': null, memory: null, garden: null, projects: null, group: null, tide: null, callhistory: null }
