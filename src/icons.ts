...
export type IconKey = 'cc' | 'api' | 'voice' | 'reading' | 'play' | 'theme' | 'status' | 'memory' | 'avatar-her' | 'avatar-his' | 'avatar-su' | 'avatar-you'
type Icons = Record<IconKey, string | null>

const DEFAULT: Icons = { cc: null, api: null, voice: null, reading: null, play: null, theme: null, status: null, memory: null, 'avatar-her': null, 'avatar-his': null, 'avatar-su': null, 'avatar-you': null }
